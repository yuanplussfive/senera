...
export interface AgentTerminalPreviewFormatterOptions {
  model: string;
  tokenLimit: number;
}

export class AgentTerminalPreviewFormatter {
  private readonly previewer: AgentModelTextPreviewer;

  constructor(options: AgentTerminalPreviewFormatterOptions) {
