...
const Schema = pluginSdk.z.object({
  ...
  includeExtensions: StringArrayObjectSchema.optional(),
  exclude: StringArrayObjectSchema.optional(),
  maxResults: pluginSdk.z.coerce.number().int().min(1).max(50).optional(),
  contextLines: pluginSdk.z.coerce.number().int().min(0).max(20).optional(),
  regex: BooleanLikeSchema.default(false),
  caseSensitive: BooleanLikeSchema.default(false),
