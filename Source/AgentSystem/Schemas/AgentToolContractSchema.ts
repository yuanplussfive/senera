...
export { ToolArtifactPolicySchema } from "./AgentArtifactContractSchema.js";
export { ToolSearchSchema } from "./AgentToolSearchContractSchema.js";

export const AgentToolDiscoverySourceSchema = z
  .object({
    Id: z.string().min(1),
...
export const ToolEvidenceCapabilitySchema = z
  .object({
...
export const ToolSchema = z
  ...
  .superRefine((tool, context) => {
    ...
    for (const issue of inspectAgentToolRuntimeContract({
    ...
    for (const issue of inspectAgentToolRuntimeCapabilityContract({
      handlerKind: tool.Handler.Kind,
      lifecycle: tool.Runtime.Lifecycle,
