...
打开 `http://localhost:8787`。运行数据默认保存在 Docker volume 里。部署、日志、非 root 容器权限和沙箱说明见 [部署与运维](docs/Operations.md)，版本变化与升级步骤见 [更新记录](CHANGELOG.md) 和 [升级指南](docs/Upgrading.md)。
