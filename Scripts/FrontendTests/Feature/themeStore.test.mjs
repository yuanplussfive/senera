...
function createStorageMock(initial) {
    ...
    if (initial)
        values.set(appearancePreferenceStorageKey, JSON.stringify(initial));
    return {
        get length() {
            return values.size;
        },
...
describe("createAppearanceStore", () => {
    it("persists partial preference updates and resolves them immediately", () => {
        ...
        expect(storage.setItem).toHaveBeenCalledWith(appearancePreferenceStorageKey, JSON.stringify({
            themeMode: "dark",
            colorScheme: "senera",
            accentColor: "violet",
            fontFamily: "brand",
