...
export const PiOpenAiMessageSchema = z
  .object({
    role: z.enum(["system", "developer", "user", "assistant", "tool"]),
    content: z.union([z.string(), z.array(z.union([TextPartSchema, ImagePartSchema])), z.null()]).optional(),
...
export const PiOpenAiToolSchema = z
  .object({
...
export const PiOpenAiChatCompletionRequestSchema = z
  .object({
...
export interface PiOpenAiUsage {
