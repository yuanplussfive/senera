    ...
    sections: [
      ...
      },
      {
        ...
        fields: [
          ...
          {
            path: ["probe", "containerMaxEntries"],
            label: "容器入口数",
            type: "number",
            min: 1,
            step: 1,
          ...
          {
            path: ["probe", "containerMaxEntryBytes"],
            label: "容器入口字节数",
            type: "number",
            min: 1,
            step: 1024,
          ...
          {
            path: ["probe", "contentTypesEntryName"],
            label: "内容类型入口",
            type: "string",
            required: false,
            essential: false,
      ...
      },
      {
        ...
        label: "解析选项",
        fields: [
          { path: ["parse", "ocr"], label: "启用 OCR", type: "boolean", required: false, essential: true },
          {
            path: ["parse", "extractAttachments"],
            label: "抽取附件",
            type: "boolean",
            required: false,
            essential: true,
          ...
          {
            path: ["parse", "includeRawContent"],
            label: "保留原始内容",
            type: "boolean",
            required: false,
            essential: true,
          },
          { path: ["parse", "ignoreNotes"], label: "忽略备注", type: "boolean", required: false, essential: true },
          { path: ["parse", "ignoreComments"], label: "忽略批注", type: "boolean", required: false, essential: true },
          {
            path: ["parse", "ignoreHeadersAndFooters"],
            label: "忽略页眉页脚",
            type: "boolean",
            required: false,
            essential: true,
          ...
          {
            path: ["parse", "ignoreInternalLinks"],
            label: "忽略内部链接",
            type: "boolean",
            required: false,
            essential: true,
      ...
      },
      {
        ...
        fields: [
          ...
          {
            path: ["output", "maxMarkdownChars"],
            label: "Markdown 预览字符数",
            type: "number",
            min: 0,
            step: 100,
            required: false,
      ...
      },
      {
        ...
        fields: [{ path: ["extractors"], label: "抽取器配置", type: "table", required: false, essential: false }],
      },
    ],
  },
});
