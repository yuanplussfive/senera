...
create table continuity_stable_prompt_snapshots ( session_id text primary key , revision text not null , resident_profile_json text not null , fact_catalog_json text not null , created_at text not null );
