...
import { deriveFeedModel, statusDotClass, statusTextClass, type FeedItem } from "../workflow/feedModel";
      ...
      <div className="mt-1.5 rounded-xl border border-ink-200/60 bg-paper-50/70">
        <DropdownMenuTrigger asChild>
          ...
          >
            ...
            <ChevronDown className={cn("h-3.5 w-3.5 shrink-0 text-ink-400 transition", expanded && "rotate-180")} />
          </button>
        </DropdownMenuTrigger>
      </div>
      <DropdownMenuContent
          ...
          {toolGroup ? (
            <div className="flex flex-col gap-1">
              <div className="flex items-center gap-2 text-[12px] text-ink-700">
                ...
                {toolGroup.meta ? <span className="font-mono text-[10.5px] text-ink-400">{toolGroup.meta}</span> : null}
              </div>
