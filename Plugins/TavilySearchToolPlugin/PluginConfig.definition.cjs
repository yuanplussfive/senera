    ...
    sections: [
      ...
      },
      {
        ...
        fields: [
          ...
          { path: ["tavily", "base_url"], label: "服务地址", type: "string", required: false, essential: false },
          {
            path: ["tavily", "timeout_seconds"],
            label: "请求超时",
            type: "number",
            min: 1,
            max: 300,
          ...
          { path: ["tavily", "state_dir"], label: "状态目录", type: "string", required: false, essential: false },
        ],
      },
    ],
  },
