...
const RequestSchedulingCatalog = {
  ...
  "agenda.get": concurrent,
  "agenda.goal.command": serial(() => "agenda-goals"),
  "world.resident.wake": serial(() => "world-resident-wake"),
  "world.get": concurrent,
  ...
  "channel.connect": serial((request) => `channel:${request.kind}`),
  "mcpInput.set": serial((request) => `mcp:${request.serverId}`),
  "mcpInput.delete": serial((request) => `mcp:${request.serverId}`),
  "mcpInput.update": serial((request) => `mcp:${request.serverId}`),
  "mcpCredential.set": serial((request) => `mcp:${request.serverId}`),
  "mcpCredential.delete": serial((request) => `mcp:${request.serverId}`),
