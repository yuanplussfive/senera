...
import { createAppearanceSnapshot, defaultAppearancePreference, normalizeAppearancePreference, readResolvedAppearance, resolveThemeMode, } from "../../../Frontend/src/shared/theme/themeModel.ts";
describe("themeModel", () => {
    ...
    it("creates a snapshot with resolved token metadata", () => {
        ...
        expect(snapshot.tokens.cssVariables).toEqual(expect.objectContaining({
