    ...
    <>
      {!isControlled ? (
        <button
          type="button"
          className={cn(
            "inline-flex h-7 shrink-0 items-center gap-1.5 rounded-md px-2 text-[11px] text-ink-500 transition hover:bg-ink-900/[0.045] hover:text-ink-800 focus:outline-none focus:ring-2 focus:ring-accent-focus",
      ...
      <Dialog open={dialogOpen} onOpenChange={handleOpenChange}>
        <DialogContent
          ...
          motionPreset="focus"
          className="flex h-[min(760px,calc(100dvh_-_24px))] max-h-none w-[min(1080px,calc(100vw_-_24px))] max-w-none flex-col overflow-hidden rounded-xl bg-paper-100 p-0 sm:w-[min(1080px,calc(100vw_-_48px))]"
          bodyClassName="flex min-h-0 flex-1 flex-col bg-paper-100 p-0"
        >
          <FileDropZone
