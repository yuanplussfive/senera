  ...
  form: {
    sections: [
      ...
      },
      {
        ...
        label: "识图供应商",
        fields: [
          { path: ["vision", "provider", "id"], label: "供应商 ID", type: "string", required: false, essential: false },
          {
            path: ["vision", "provider", "title"],
            label: "供应商名称",
            type: "string",
            required: false,
            essential: false,
          ...
          {
            path: ["vision", "provider", "apiVersion"],
            label: "接口版本",
            type: "string",
            required: false,
            essential: false,
          },
          { path: ["vision", "provider", "model"], label: "模型", type: "string", required: true, essential: true },
          {
            path: ["vision", "provider", "temperature"],
            label: "温度",
            type: "number",
            min: 0,
            max: 2,
          ...
          {
            path: ["vision", "provider", "maxRequestSeconds"],
            label: "总请求时限",
            type: "number",
            min: -1,
            step: 1,
          ...
          {
            path: ["vision", "provider", "maxNetworkRetries"],
            label: "网络重试次数",
            type: "number",
            min: 0,
            step: 1,
