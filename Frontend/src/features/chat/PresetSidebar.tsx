...
export function PresetSidebar({
  ...
  return (
    <aside className="flex h-[210px] min-h-0 w-full min-w-0 shrink-0 flex-col border-b border-line bg-surface-subtle sm:h-full sm:w-[240px] sm:border-b-0 sm:border-r">
