...
describe("plugin settings presentation", () => {
  it("keeps system extension internals out of the default tool directory", () => {
    ...
    expect(screen.getAllByText("工作区工具")).toHaveLength(2);
  ...
  it("keeps MCP configuration focused on user-editable inputs", () => {
    ...
    expect(screen.getAllByText("imagen")).toHaveLength(2);
    expect(
