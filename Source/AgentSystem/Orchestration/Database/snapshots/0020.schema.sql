...
-- index: child_runs_join_group_idx
create index child_runs_join_group_idx on child_runs ( json_extract ( join_group_json , '$.id' ) , status , created_at );
...
-- index: child_runs_parent_work_item_idx
create unique index child_runs_parent_work_item_idx on child_runs ( parent_session_id , work_item_id );

-- index: child_runs_status_idx
create index child_runs_status_idx on child_runs ( status , updated_at );

-- index: child_runs_task_digest_idx
create index child_runs_task_digest_idx on child_runs ( parent_session_id , task_digest , created_at desc );
